...
func ProbeTopLevelDomains(TLDCache *expirecache.Cache, TLDPrefixes []TLDPrefix, backends []backend.Backend, period int32, reqTotal prometheus.Counter, errors prometheus.Counter) {
